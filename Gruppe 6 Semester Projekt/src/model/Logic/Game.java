...
//      Airlock room items:
    ...
    public String printWelcome() {
        return "Welcome to World Of Zuul! World Of Zuul is a new, incredibly exciting adventure game.This is a waliking maze,in which you need to collect items,solve puzzles" +
                "in the room,defeat monster,try your best to get clues,get favourable props,interact with NPC,and send a message to the outside world and " +
